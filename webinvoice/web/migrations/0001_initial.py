# Generated by Django 2.1 on 2019-07-15 04:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_pref', models.CharField(choices=[('北海道', '北海道'), ('青森県', '青森県'), ('岩手県', '岩手県'), ('宮城県', '宮城県'), ('秋田県', '秋田県'), ('山形県', '山形県'), ('福島県', '福島県'), ('茨城県', '茨城県'), ('栃木県', '栃木県'), ('群馬県', '群馬県'), ('埼玉県', '埼玉県'), ('千葉県', '千葉県'), ('東京都', '東京都'), ('神奈川県', '神奈川県'), ('新潟県', '新潟県'), ('富山県', '富山県'), ('石川県', '石川県'), ('福井県', '福井県'), ('山梨県', '山梨県'), ('長野県', '長野県'), ('岐阜県', '岐阜県'), ('静岡県', '静岡県'), ('愛知県', '愛知県'), ('三重県', '三重県'), ('滋賀県', '滋賀県'), ('京都府', '京都府'), ('大阪府', '大阪府'), ('兵庫県', '兵庫県'), ('奈良県', '奈良県'), ('和歌山県', '和歌山県'), ('鳥取県', '鳥取県'), ('島根県', '島根県'), ('岡山県', '岡山県'), ('広島県', '広島県'), ('山口県', '山口県'), ('徳島県', '徳島県'), ('香川県', '香川県'), ('愛媛県', '愛媛県'), ('高知県', '高知県'), ('福岡県', '福岡県'), ('佐賀県', '佐賀県'), ('長崎県', '長崎県'), ('熊本県', '熊本県'), ('大分県', '大分県'), ('宮崎県', '宮崎県'), ('鹿児島県', '鹿児島県'), ('沖縄県', '沖縄県')], max_length=10, verbose_name='契約者都道府県')),
                ...
                ('hp_url', models.CharField(blank=True, max_length=100, null=True, verbose_name='URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_1', models.CharField(max_length=50, verbose_name='住所1')),
                ('address_2', models.CharField(max_length=50, verbose_name='住所2')),
                ...
                ('date_created', models.DateField(default=django.utils.timezone.now, verbose_name='作成日')),
        ...
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ('id', models.CharField(max_length=50, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z_]*$', 'IDは英数字もしくはアンダースコア(_)のみとしてください')], verbose_name='請求書ID')),
                ('registered_at', models.DateTimeField(auto_now_add=True, verbose_name='登録日')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
        ...
        migrations.CreateModel(
            name='InvoiceDetail',
            fields=[
                ('id', models.CharField(max_length=50, primary_key=True, serialize=False, unique=True, verbose_name='請求明細ID')),
                ...
                ('invoice_code', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z_]*$', 'IDは英数字もしくはアンダースコア(_)のみとしてください')], verbose_name='請求書ID')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
                ('deleted', models.BooleanField(default=False, verbose_name='削除フラグ')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='details', to='web.Invoice', verbose_name='請求書')),
            ],
            options={
                'verbose_name': '請求明細',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_address_pref', models.CharField(choices=[('北海道', '北海道'), ('青森県', '青森県'), ('岩手県', '岩手県'), ('宮城県', '宮城県'), ('秋田県', '秋田県'), ('山形県', '山形県'), ('福島県', '福島県'), ('茨城県', '茨城県'), ('栃木県', '栃木県'), ('群馬県', '群馬県'), ('埼玉県', '埼玉県'), ('千葉県', '千葉県'), ('東京都', '東京都'), ('神奈川県', '神奈川県'), ('新潟県', '新潟県'), ('富山県', '富山県'), ('石川県', '石川県'), ('福井県', '福井県'), ('山梨県', '山梨県'), ('長野県', '長野県'), ('岐阜県', '岐阜県'), ('静岡県', '静岡県'), ('愛知県', '愛知県'), ('三重県', '三重県'), ('滋賀県', '滋賀県'), ('京都府', '京都府'), ('大阪府', '大阪府'), ('兵庫県', '兵庫県'), ('奈良県', '奈良県'), ('和歌山県', '和歌山県'), ('鳥取県', '鳥取県'), ('島根県', '島根県'), ('岡山県', '岡山県'), ('広島県', '広島県'), ('山口県', '山口県'), ('徳島県', '徳島県'), ('香川県', '香川県'), ('愛媛県', '愛媛県'), ('高知県', '高知県'), ('福岡県', '福岡県'), ('佐賀県', '佐賀県'), ('長崎県', '長崎県'), ('熊本県', '熊本県'), ('大分県', '大分県'), ('宮崎県', '宮崎県'), ('鹿児島県', '鹿児島県'), ('沖縄県', '沖縄県')], max_length=10, verbose_name='請求都道府県')),
                ('invoice_address_city', models.CharField(max_length=100, verbose_name='請求市区町村')),
                ('invoice_address_street', models.CharField(max_length=100, verbose_name='請求住所番地以降')),
                ('invoice_address_bld', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求住所建物名')),
                ('invoice_company_name', models.CharField(max_length=100, verbose_name='請求会社名')),
                ('invoice_dept', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求部署')),
                ('invoice_person', models.CharField(max_length=100, verbose_name='請求宛名')),
                ('invoice_project_1', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求宛名1')),
                ('invoice_project_2', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求宛名2')),
                ('invoice_project_3', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求宛名3')),
                ('payment_method', models.CharField(max_length=100, verbose_name='支払い方法')),
                ('invoice_closed_at', models.CharField(blank=True, max_length=100, null=True, verbose_name='締め日')),
                ('payment_due_to', models.DateField(default=django.utils.timezone.now, verbose_name='支払い期日')),
                ('invoice_sent_at', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求書送付時期')),
                ('invoice_timing', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求タイミング')),
                ('invoice_period', models.CharField(blank=True, max_length=100, null=True, verbose_name='請求周期')),
                ('bank_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='振込銀行名')),
                ('bank_branch_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='振込支店名')),
                ('bank_account_type', models.CharField(blank=True, choices=[('普通', '普通'), ('当座', '当座')], max_length=100, null=True, verbose_name='口座種類')),
                ('bank_account_number', models.CharField(blank=True, max_length=20, null=True, verbose_name='口座番号')),
                ('credit_card_settlement_company', models.CharField(blank=True, max_length=100, null=True, verbose_name='クレカ決済会社')),
                ('credit_card_code', models.CharField(blank=True, max_length=100, null=True, verbose_name='クレカコード')),
                ('credit_card_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='クレカID')),
                ('settlement_company', models.CharField(blank=True, max_length=100, null=True, verbose_name='決済会社')),
                ('settlement_code', models.CharField(blank=True, max_length=100, null=True, verbose_name='決済コード')),
                ('settlement_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='決済ID')),
