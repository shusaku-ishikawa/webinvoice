# Generated by Django 2.1.5 on 2019-05-19 11:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日')),
                ('deleted', models.BooleanField(default=False, verbose_name='削除フラグ')),
                ('invoice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='details', to='web.Invoice', verbose_name='請求書')),
            ],
            options={
                'verbose_name': '請求明細',
